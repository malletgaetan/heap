class Token:
   ...
   BEGIN, END, INTEGER_DIV, PROGRAM, COMMENT_START, COMMENT_END, IF = ('BEGIN', 'END', 'DIV', 'PROGRAM', '{', '}')
...
# condition_statement: LPAREN cond RPAREN
# cond_op: and || or
# cond: expr_comparaison | LPAREN expr_comparaison cond_op cond RPAREN

# cond_comp: >= | > | < | <= | ==
# cond_expr: LPAREN expr RIGHTPAREN | !+ factor
# expr_comparaison: cond_expr | LPAREN cond_expr cond_comp cond_expr RPAREN
...
# if it respect the condition, operator in [>, >=, <=, ==]
class BinCond(AST):
   pass
